...
import { startCheckoutSession } from '@features/billing/services/checkout.server'
...
async function requireOwner() {
  ...
  return { db, tenantId, actorUserId }
}

/** POST — create Razorpay Order + open GST invoice for checkout */
